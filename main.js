...
function windowHandler(windowId) {
  var windowElementClassList = document.getElementById(windowId).classList;
  console.log(windowElementClassList);
...
function maximizeHandler(windowId) {
  var windowElementClassList = document.getElementById(windowId).classList;
  console.log("win", windowElementClassList);
...
function dragElement(windowId, headerId) {
  ...
  if (document.getElementById(windowElement.id + headerId)) {
    ...
    document.getElementById(windowElement.id + headerId).onmousedown =
      dragMouseDown;
  } else {
